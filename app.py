...
figx = px.line(result, x="Date", y1="Average price (actual)")
figx = px.line(result, x="Date", y2="Average price predicted for the next 30 days with 100 days windows period")
